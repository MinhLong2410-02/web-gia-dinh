    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person1', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='person1_relationships', to='home.people')),
                ('person2', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='person2_relationships', to='home.people')),
            ],
        ),
    ]
